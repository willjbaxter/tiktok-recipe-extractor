...
export default function ConfigPanel({ onExtract,loading }: ConfigPanelProps) {
  ...
  return (
    ...
    <div className="flex items-center mb-8">
      ...
      <GitHubButton href="https://github.com/abakermi/tiktok-recipe-extractor" data-color-scheme="no-preference: dark; light: light; dark: dark;" data-size="large" data-show-count="true" aria-label="Star abakermi/tiktok-recipe-extractor on GitHub">Star</GitHubButton>
    </div>
    <Card>
      <CardHeader>
